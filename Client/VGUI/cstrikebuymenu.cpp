...
{
	m_pMainMenu->LoadControlSettings("Resource/UI/BuyMenu_CT.res", "GAME");
...
{
	m_pMainMenu->LoadControlSettings("Resource/UI/BuyMenu_TER.res", "GAME");
	m_pMainMenu->SetVisible(false);
...
CCSBuySubMenu::CCSBuySubMenu(vgui2::Panel *parent, const char *name) : CBuySubMenu(parent, name)
{
	...
	m_pLoadout = new BuyPresetEditPanel(this, "loadoutPanel", "Resource/UI/Loadout.res", 0, false);
