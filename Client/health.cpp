...
void __fastcall CHudHealth_Draw(void *pthis, int, float flTime)
{
}

int CHudHealth::Init(void)
{
	g_pMetaHookAPI->InlineHook(g_pfnCHudHealth_Draw, CHudHealth_Draw, (void *&)g_pfnCHudHealth_Draw);
...
int CHudHealth::MsgFunc_Health(const char *pszName, int iSize, void *pbuf)
{
	...
	return g_pfnMSG_Health(pszName, iSize, pbuf);
}
...
int CHudHealth::MsgFunc_Damage(const char *pszName, int iSize, void *pbuf)
{
	...
	return g_pfnMSG_Damage(pszName, iSize, pbuf);
}
