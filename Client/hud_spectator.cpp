...
int __fastcall CHudSpectator_Draw(void *pthis, int, float flTime)
{
	return 1;
}
...
int CHudSpectator::Init(void)
{
	...
	g_pMetaHookAPI->InlineHook(g_pfnCHudSpectator_Draw, CHudSpectator_Draw, (void *&)g_pfnCHudSpectator_Draw);
