...
int __fastcall CHudAccountBalance_Draw(void *pthis, int, float flTime)
{
	return 1;
}
...
{
	g_pMetaHookAPI->InlineHook(g_pfnCHudAccountBalance_Draw, CHudAccountBalance_Draw, (void *&)g_pfnCHudAccountBalance_Draw);
