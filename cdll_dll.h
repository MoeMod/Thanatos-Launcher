...
#define MENU_KEY_NEXT (1<<10)
#define MENU_KEY_PREV (1<<11)

#define MENU_FLAG_PREV (1<<0)
#define MENU_FLAG_PREV_DISABLE (1<<1)
#define MENU_FLAG_NEXT (1<<2)
#define MENU_FLAG_NEXT_DISABLE (1<<3)
#define MENU_FLAG_EXIT (1<<4)
#define MENU_FLAG_EXIT_DISABLE (1<<5)
